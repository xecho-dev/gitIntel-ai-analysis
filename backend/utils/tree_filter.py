...
ALWAYS_KEEP_PATTERNS: set[str] = {
    ...
    "go.mod", "go.sum", "Cargo.toml", "Gemfile", "Gemfile.lock",
    ...
    "README.md", "readme.md", "CHANGELOG.md", "LICENSE", "NOTICE",
    ".gitignore", ".gitattributes", "renovate.json", ".editorconfig",
    "turbo.json", "pnpm-workspace.yaml", "lerna.json",
    "Rakefile", "rakefile", "Procfile", ".ruby-version",
}
